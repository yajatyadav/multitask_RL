...
keys_to_load = ['obs/agentview_rgb', 'obs/eye_in_hand_rgb']
augment_negative_demos = False
env, eval_env, train_dataset, val_dataset = make_env_and_datasets(env_name, task_name=task, keys_to_load=keys_to_load, augment_negative_demos=augment_negative_demos)
