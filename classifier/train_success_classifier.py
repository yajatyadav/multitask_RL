...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, required=False, default='exp/multitask_RL/success_classifier_train/')
    parser.add_argument('--rollouts_dir', type=str, required=False, default='bcactor_collected_rollouts/bcflow_libero_90_25_demo_ckpt_80k')
