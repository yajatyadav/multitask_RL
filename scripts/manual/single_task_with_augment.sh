...
uv run main.py \
--exp_name_prefix=libero90_livingroomscene1_singletask_one_other_task__augmentation_IMAGE_ \
...
--augmentation_dict='{"pick_up_the_alphabet_soup_and_put_it_in_the_basket": ["pick_up_the_ketchup_and_put_it_in_the_basket"]}' \
\
--use_pixels=True \
--use_proprio=True \
--use_language=True \
