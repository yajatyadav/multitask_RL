...
class IQLPi0ActorAgent(flax.struct.PyTreeNode):
    ...
    def sample_actions(
        ...
        for _ in range(self.config['pi0_best_of_n_samples']):
            ...
            sampled_actions.append(action.squeeze(0)) # squueze needed so that concatenation with the encoder output works out in the value net
        ...
        best_action = best_action.reshape(1, -1)
